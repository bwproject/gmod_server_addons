...
function PHX.UI.BaseMainMenu(ply, cmd, args)
	...
	function PHX.UI:DonationPanel()
		...
		BMAC:SetImage(PHX.BWGetMenuAsset("BMAC", "vgui/phx_menu/bmac.png"))
		local KOFI = pn:Add("DImage")
		KOFI:SetPos(260,0)
		KOFI:SetSize(256,128)
		KOFI:SetImage(PHX.BWGetMenuAsset("KOFI", "vgui/phx_menu/kofi.png"))
		...
		btnDn.DoClick = function()
			gui.OpenURL(PHX.BWGetMenuAsset("DonateRushURL", "https://gmod.projectbw.ru"))
		end
	...
	function PHX.UI:HelpSelections()
		...
		helpImage:SetImage(PHX.BWGetHelpAsset(1, "vgui/phx_menu/phhelp1.png"))
		...
		bnext.DoClick = function(pnl)
			...
			helpImage:SetImage(PHX.BWGetHelpAsset(helpImage.Count, "vgui/phx_menu/phhelp"..helpImage.Count..".png"))
		end
		...
		local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("Help", "vgui/phx_menu/m_help.png"))
	...
	function PHX.UI:PlayerModelSelections()
		...
		local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("PlayerModel", "vgui/phx_menu/m_plmodel.png"))
	...
	function PHX.UI:PlayerOption()
		...
		local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("Player", "vgui/phx_menu/m_player.png"))
	...
	function PHX.UI:PlayerMute()
		...
		local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("Voice", "vgui/phx_menu/m_voice.png"))
	...
	local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("Admin", "vgui/phx_menu/m_admin.png"))
	...
	function PHX.UI:MapVoteMenu()
		...
		local PanelModify = PHX.UI.PnlTab:AddSheet("", panel, PHX.BWGetMenuAsset("MapVote", "vgui/phx_menu/m_map.png"))
