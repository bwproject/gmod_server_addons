...
L["PHXM_ADMIN_BEVERBOSE"]				= "Developer: Zezwalaj PH:BW na wyświetlanie wszystkich informacji deweloperskich (dosłownie)?"
...
L["PHXM_ABOUT_BTN_DONATE"]				= "Wspomóż PH:BW poprzez dotację"
